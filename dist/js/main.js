...
var App = (function () {
    ...
    App.prototype.onPrimaryClick = function (e) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        e.preventDefault();
                        $(e.target).blur();
                        if (!!this.currentGame) return [3 /*break*/, 2];
                        this.currentGame = new GameSession_1["default"]();
                        return [4 /*yield*/, this.startCountdown(3)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    App.prototype.onSecondaryClick = function (e) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                e.preventDefault();
                $(e.target).blur();
    ...
    App.prototype.startCountdown = function (startNumber) {
        if (this.countdown) {
            return;
        }
...
var GameSession = (function () {
    ...
    GameSession.prototype.isLastTurn = function () {
        return this.turnNumber === this.shuffledLetters.length - 1;
    };
    GameSession.prototype.getCurrentLetter = function () {
        if (this.turnNumber < this.shuffledLetters.length) {
